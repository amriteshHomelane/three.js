...
function RectAreaLightHelper( light ) {
	...
	var lightShape = new THREE.PlaneGeometry( this.light.width, this.light.height );

	// shows the "front" of the light, e.g. where light comes from

	this.add( new Mesh( geometry, this.materialFront ) );
...
RectAreaLightHelper.prototype.update = function () {
	...
	return function update() {
		...
		uvArray[  0 ] =   1; uvArray[  1 ] =   0;
		uvArray[  2 ] =   1; uvArray[  3 ] =   1;
		uvArray[  4 ] =   0; uvArray[  5 ] =   1;
		...
		uvArray[ 8 ] =  0; uvArray[ 9 ] = 	0;
		uvArray[ 10 ] = 1; uvArray[ 11 ] =   0;
